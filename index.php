          ...
          <div class="col-lg-7 col-md-12 col-sm-12">
            <div class="banner-ct-wrap">
              <div class="banner-head">
                <h1>NACIMOS ENTRE LOS GRANDES <span class="cl-blue">PARA SER LOS MEJORES</span></h1>
              </div>
              <div class="banner-content pt-2 pb-4">
                <p>
Prestigiosa institucion Educativa                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-5 col-md-12 col-sm-12 p-0">
            <div class="banner-image1">
              <img  class="banner-image1"src="images/banner/Izquierdo_Rios.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="services-main">
      <div class="container">
        <div class="service-full wow fadeInUp">
          <div class="row">
            <div class="col-lg-4 col-md-12">
              <div class="service-main d-flex align-items-center">
                <div class="service-inner">
                  <h3 class="mb-3 pb-3">NUESTRO SERVICIO</h3>
                  <p class="mb-4">
                    El Colegio Francisco Izquierdo Ríos ofrece una educación de calidad orientada al desarrollo integral de sus estudiantes, asegurando no solo su éxito académico, sino también su crecimiento personal y social en un ambiente que promueve la curiosidad, la creatividad y el compromiso con la comunidad. Con un enfoque que valora tanto el aprendizaje cognitivo como el desarrollo emocional, el colegio se distingue por formar ciudadanos responsables y preparados para enfrentar los desafíos del futuro. Aquí tienes seis razones para elegir este colegio
              ...
              <div class="row service-list-wrap">
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="service-ct-list mb-4">
                    ...
                    <p class="m-0">Se enfoca en el desarrollo académico, emocional y social de los estudiantes.</p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="service-ct-list mb-4">
                    <i class="fas fa-book-open"></i>
                    <h4>VALORES CULTURALES</h4>
                    <p class="m-0">Fomenta el respeto por la diversidad y la identidad cultural peruana</p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="service-ct-list mb-4">
                    ...
                    <p class="m-0">Utiliza métodos de enseñanza modernos que integran tecnología y pedagogía</p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="service-ct-list">
                    ...
                    <p class="m-0">Ofrecemos atención personalizada para garantizar que cada estudiante alcance su máximo potencial.</p>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="service-ct-list">
                    ...
                    <h4>ASERORIA A LOS ESTUDIANTES</h4>
                    <p class="m-0">Ofrecemos atention a los estudiantes con tutores las 24 horas del dia</p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="service-ct-list">
                    ...
                    <p class="m-0">Ofrecemos una variedad de actividades deportivas a los estudiantes</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-md-12 wow fadeInLeftBig">
            <div class="">
              <img class="about-wrap-img1" src="images/banner/francisco izquierod rios.jpg" alt="" />
            </div>
          </div>
          <div class="col-lg-7 col-md-12 wow fadeInRightBig">
            <div class="about-us-wrap">
              <div class="">
                <h3 class="tittle-Histori"> FRANCISCO IZQUIERDO RIOS</h3>
              </div>
              <div class="mb-4">
                <p>
                  Francisco Izquierdo Ríos (1910-1981) fue un escritor, poeta y educador peruano nacido en Saposoa, en la región San Martín. Su obra se caracteriza por retratar la vida rural del Perú, especialmente en la selva y la sierra, utilizando un lenguaje auténtico y cercano. Es reconocido por cuentos como "El Bagrecico", emblemático en la literatura infantil peruana, y por su libro "La escuela de los montes", 
                </p>
                <p class="mb-4">
                  que refleja la realidad de las escuelas rurales. Además de su labor literaria, Izquierdo Ríos fue un ferviente promotor de la educación y la cultura, desempeñando roles importantes en el Ministerio de Educación del Perú. Su legado perdura como una valiosa contribución a la identidad cultural peruana.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="counter-wrap wow fadeInUp">
          <div class="content d-flex justify-content-between">
            ...
            <div class="value-pin">
              <span class="countfect value" data-num="100"></span>
              <h5>PROFESORES</h5>
            </div>
            <div class="value-pin">
              <span class="countfect value" data-num="800 "></span>
              <h5>ESTUDIANTES</h5>
            </div>
            <div class="value-pin">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 customize-wrap mb-4 wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="course-detail.html">DIGITAL MARKETING | SOCIAL MEDIA MARKETING BUSINESS</a>
                  </h4>
    ...
    <section class="blog-article p-0">
      <div class="container">
